...
An interactive machine learning web app that estimates diabetes likelihood from glucose level, BMI, age, and pregnancies. Built as an independent data science project using Python, scikit-learn, and Streamlit.

## 🌐 Live Demo

👉 [Launch the Diabetes Risk Predictor]([https://your-streamlit-link.streamlit.app](https://diabetes-risk-predictor-xvulinwxwv8wbv3kqfykxs.streamlit.app/#why-this-prediction))

## 📸 App Preview

![Diabetes Risk Predictor](images/app-preview.png)
...
* Interactive health input sliders
...
The app uses a Logistic Regression model trained on four features:
...
The model achieved about **75% accuracy** on test data.
...
* Pregnancy count showed a weaker relationship with diabetes than glucose or BMI.
